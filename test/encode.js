...
test('should force keys to be strings', function (t) {
  var data = { 12: 'Hello World', 34: 12345 }
...
test('should be able to encode a string', function (t) {
  t.same(bencode.encode('asdf').toString(), '4:asdf')
  t.same(bencode.encode(':asdf:').toString(), '6::asdf:')
  t.end()
})

test('should be able to encode a unicode string', function (t) {
  t.deepEqual(bencode.encode(fixture.binStringData.toString()), fixture.binResultData)
  t.deepEqual(bencode.encode(fixture.binStringData.toString()), fixture.binResultData)
  t.end()
})
...
test('should be able to encode an array', function (t) {
  ...
  t.same(bencode.encode([ ':asdf:' ]).toString(), 'l6::asdf:e')
  t.end()
})

test('should be able to encode an object', function (t) {
  t.same(bencode.encode({ 'a': 'bc' }).toString(), 'd1:a2:bce')
  t.same(bencode.encode({ 'a': '45', 'b': 45 }).toString(), 'd1:a2:451:bi45ee')
  t.end()
})
